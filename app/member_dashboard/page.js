...
import { 
  ...
  FiChevronUp, FiBox, FiDatabase, FiStar, FiClock, FiMenu, FiX, FiCreditCard 
} from 'react-icons/fi';
...
const menuItems = [
  ...
  { 
    name: 'Book Now', 
    icon: <LuBookmarkPlus className="w-5 h-5" />,
    link: 'book_now',
    subItems: []
  },
  { 
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="relative p-2 flex flex-col items-center">
            ...
            <Image 
              src={darkMode ? "/logo/memberDashboardSidebar_logo_dark.svg" : "/logo/memberDashboardSidebar_logo_light.svg"} 
              alt="Dashboard Logo"
        ...
        <motion.div
          ...
          >
            ...
            <div className="relative w-12 h-12"> {/* Ensures fixed size */}
              <Image
                src={memberData?.profile_image || '/default-avatar.jpg'}
                alt="Profile"
                width={48}
                height={48}
      ...
      <AnimatePresence>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: 'Upcoming Schedule', value: 12, icon: <FiFileText /> },
              { title: 'Complete', value: 3, icon: <LiaProjectDiagramSolid /> },
              { title: 'Booking Count', value: 8, icon: <FiDatabase /> }
            ].map((card, index) => (
              <motion.div
                key={card.title}
          ...
          {/* book_now route handling */}
          {activeMenu === 'book_now' && (
            <BookNow 
              darkMode={darkMode} 
              onProceed={() => setActiveMenu('payment')}
            />
          )}
