    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.type === 'Admin') {
          ...
          toast.success('Welcome! PMA MEMBER');
      ...
      <div className="flex flex-col md:flex-row bg-white/10 backdrop-blur-lg rounded shadow-lg max-w-4xl w-full p-6 md:p-0">
        ...
        <div className="flex flex-col items-center justify-center md:w-1/2 p-6">
          ...
          <div className="mb-4 text-center">
            <Image src="/logo/logo.svg" alt="Logo" width={128} height={128} className="mx-auto" priority />
            <h2 className="text-xl font-bold leading-6 mt-4 text-[#012970]">ULTIMATE FUTSAL EXPERIENCE</h2>
          </div>

          <div className="relative w-full max-w-sm">
            <div className="bg-white-800 p-6 rounded shadow-md">
              <h3 className="text-xl font-semibold leading-6 mb-4 tracking-tighter text-center text-[#012970]">Login</h3>
              <p className="mt-1.5 text-m font-medium text-gray-800 text-center">Welcome PLAY MAKERS ARENA</p>
              <p className="mt-1.5 text-sm font-medium text-gray-800 text-center">Enter Your Credentials To Continue</p>
                ...
                <div>
                  <div className="group relative rounded border px-3 pb-1.5 pt-2.5 duration-200 focus-within:ring border-[#012970] shadow-[0_0_0_1px_rgba(1,41,112,0.3)]">
                    ...
                    <input
                      ...
                      className="block w-full border-0 bg-transparent p-0 text-sm placeholder:text-gray-800/60 focus:outline-none focus:ring-0 sm:leading-7 text-gray-900"
                      required
                    />
                  </div>
                </div>
